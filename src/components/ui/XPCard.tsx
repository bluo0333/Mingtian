...
export default function XPCard({ level, message, current, total, totalXp }: XPCardProps) {
  ...
  return (
    <div className="card-soft p-4 sm:p-5">
      ...
      <div className="relative h-[10px] rounded-full overflow-hidden bg-jade-100 dark:bg-charcoal-700/80">
        <motion.div
          className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-jade-800 to-jade-500 dark:from-dark-400 dark:to-dark-200"
          initial={{ width: '0%' }}
          animate={{ width: `${pct}%` }}
